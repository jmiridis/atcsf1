...
<table id="myTable" class="tablesorter">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $reservation->getFirstname();?> <?php echo $reservation->getLastname();?><br/><a href="mailto:<?php echo $reservation->Client->email_address;?>"><?php echo $reservation->Client->email_address;?></a></td>
