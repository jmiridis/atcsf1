...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'W:\\Projects\\atcsf1\\log/frontend_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'W:\\Projects\\atcsf1\\cache\\frontend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'W:\\Projects\\atcsf1\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'W:\\Projects\\atcsf1\\cache\\frontend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'W:\\Projects\\atcsf1\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'reservation@americantransferscancun.com',
      'password' => 'u5ZjD73y',
    ),
  ),
))));
