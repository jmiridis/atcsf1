 ...
 * @method Client                get()                      Returns the current record's "Profile" value
 ...
 * @method sfGuardUser           set()                      Sets the current record's "Profile" value
 * 
 * @package    atc
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Client as Profile', array(
             'local' => 'id',
